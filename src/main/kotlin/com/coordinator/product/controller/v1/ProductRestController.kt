...
class ProductRestController(
    ...
    fun getMinPriceAndMaxPriceByCategory(@RequestParam category: Category) =
        productService.getMinPriceAndMaxPriceByCategory(category = category).let(::MinPriceAndMaxPriceResponse)
}
